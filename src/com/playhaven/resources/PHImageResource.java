...
public class PHImageResource extends PHResource {
	...
	private HashMap<Integer, Bitmap> cached_images = new HashMap<Integer, Bitmap>();
	
	//map between device density enum and base64 data
	private HashMap<Integer, String> data_map = new HashMap<Integer, String>();
	...
	public Bitmap loadImage(int densityType) {
	...
	public BitmapDrawable loadBitmapDrawable(Resources res, int densityType) {

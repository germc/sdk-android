...
/** Simple customized adapter to handle rows with title and detail view. Just provide objects
 * which conform to the {@link DetailObject} protocol for providing detail objects. 
 * 
